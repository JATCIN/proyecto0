...
def export_pdf():
    ...
    if 'loggedin' in session:
        ...
        try:
            ...
            pdf.cell(285, 10, txt="Reporte Transferencias", ln=True, align='C')
...
def export_pdf_pactos():
    ...
    if 'loggedin' in session:
        ...
        try:
            ...
            pdf.cell(28, 10, "ID Pacto", 1)
            pdf.cell(28, 10, "Banco Origen", 1)
            pdf.cell(28, 10, "Banco Destino", 1)
            pdf.cell(28, 10, "Monto", 1)
            pdf.cell(28, 10, "Cuenta Origen", 1) 
            pdf.cell(28, 10, "Cuenta Destino", 1) 
            pdf.cell(28, 10, "Tipo de cambio", 1)
            pdf.cell(28, 10, "Comision", 1)
            pdf.cell(28, 10, "Status", 1)
            ...
            for row in records:
                pdf.cell(28, 10, str(row['id_pacto']), 1)
                pdf.cell(28, 10, row['banco_origen'], 1)
                pdf.cell(28, 10, row['banco_destino'], 1)
                pdf.cell(28, 10, str(row['monto']), 1)
                pdf.cell(28, 10, row['cuenta_origen'], 1)
                pdf.cell(28, 10, row['cuenta_destino'], 1)
                pdf.cell(28, 10, str(row['tipo_cambio']), 1)
                pdf.cell(28, 10, str(row['comision']), 1)
                pdf.cell(28, 10, str(row['status']), 1)
                pdf.cell(28, 10, row['fecha_hora'].strftime("%Y-%m-%d"), 1)
...
def export_pdf_usuarios():
    ...
    if 'loggedin' in session:
        ...
        try:
            ...
            pdf.cell(28, 10, "Fecha", 1)
            pdf.cell(45, 10, "Id transferencias asiganadas", 1)
            pdf.ln()
            ...
            for row in records:
                ...
                pdf.cell(45, 10, str(row['transferencia_ids']), 1)
