...
def export_pdf_pactos():
    ...
    if 'loggedin' in session:
        ...
        try:
            ...
            for row in records:
                pdf.cell(30, 10, str(row['id_pacto']), 1)
                pdf.cell(30, 10, row['banco_origen'], 1)
                pdf.cell(30, 10, row['banco_destino'], 1)
                pdf.cell(30, 10, str(row['monto']), 1)
                pdf.cell(30, 10, row['cuenta_origen'], 1)
                pdf.cell(30, 10, row['cuenta_destino'], 1)
                pdf.cell(30, 10, str(row['tipo_cambio']), 1)
                pdf.cell(30, 10, str(row['comision']), 1)
                pdf.cell(30, 10, str(row['status']), 1)
                pdf.cell(30, 10, row['fecha_hora'].strftime("%Y-%m-%d"), 1)
