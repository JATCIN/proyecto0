...
def export_pdf():
    ...
    if 'loggedin' in session:
        ...
        try:
            ...
            pdf.cell(20, 10, "Usuario", 1)
            pdf.cell(30, 10, "Email", 1)
            pdf.cell(20, 10, "Banco Origen", 1)
            pdf.cell(20, 10, "Cuenta Origen", 1)
            pdf.cell(20, 10, "Banco Destino", 1)
            pdf.cell(20, 10, "Cuenta Destino", 1)
            pdf.cell(20, 10, "Monto", 1)
            pdf.cell(20, 10, "Tipo de cambio", 1)
            pdf.cell(20, 10, "Comision", 1)
            pdf.cell(20, 10, "Fecha", 1)
            pdf.cell(20, 10, "Id pacto asignado", 1)
            pdf.ln()
